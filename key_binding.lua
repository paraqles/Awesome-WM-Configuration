--
--------------------------------------------------------------------------------
--         FILE:  key_binding.lua
--        USAGE:  NONE
--  DESCRIPTION:  Bind definitions for keyboard and mouse keys in awesome
--      OPTIONS:  ---
-- REQUIREMENTS:  ---
--         BUGS:  ---
--        NOTES:  ---
...
--      COMPANY:  
--      VERSION:  1.0
--      CREATED:  01.03.2011 21:18:47 CET
--     REVISION:  ---
--------------------------------------------------------------------------------
--
...
globalkeys = awful.util.table.join(
  ...
  awful.key({ modkey, }, "y",
    function()
      if not screensaver_running then
  ...
  awful.key({}, "XF86AudioLowerVolume",
    function()
      awful.util.spawn( "amixer -q sset Master 6dB-" )
    end
  ),
